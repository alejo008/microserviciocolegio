# Diseño Funcional Operación colegioNombres
...
Servicio que trae de la BD llamada colegio y trae información de las tablas tbl_salones,tbl_alumnos,tbl_materias según el numero serial ingresado nos mostrara el nombreSalon,nombreAlumno,nombreMateria y notaFinal.
...
| **Sintaxis** | JSON |
| **Método HTTP** | GET |
| **Path externo** | ***/[nivel 1 eTOM)]/[telefonica]/[version]/[nombre_microservicio]/[nombre_operación][parametros]***<br> /service/nttdata/v1/prueba-microcolegio1/colegioNombres?String=  |
| **Path interno** | ***/[telefonica]/[version]/[nombre_microservicio]/[nombre_operación][parametros]***<br> /nttdata/v1/prueba-microcolegio1/colegioNombres?String=  | |
...
```json
/nttdata/service/v1/prueba-microcolegio1/colegioNombres?nombreAlumno=Laura Diaz 
...
| -------- | -------- | -------- |-------- | -------- |
| nombreAlumno     | it is a pass through     | Text     |STRING     | Request Param     |
